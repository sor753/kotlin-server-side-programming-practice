...
// Domain層の型（BookRepositoryが返すべき型）をimport
...
class JooqBookRepositoryImpl(
    ...
    override fun findAllWithRental(): List<BookWithRental> {
        return dsl.select()
            ...
            .leftJoin(RENTAL).on(BOOK.ID.eq(RENTAL.BOOK_ID))
            ...
            .fetch { record ->
                BookWithRental(
                    ...
                    rental = record[RENTAL.ID]?.let { rentalId ->
                        Rental(
                            id = rentalId,
